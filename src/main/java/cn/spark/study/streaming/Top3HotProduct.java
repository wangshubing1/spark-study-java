...
public class Top3HotProduct {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JavaPairDStream<String, Integer> categoryProductPairsDStream =
                productClickLogsDStream.mapToPair(m -> new Tuple2<>(
                        (m.split(" ")[2] + "_" + m.split(" ")[1]), 1));
        ...
        JavaPairDStream<String, Integer> categoryProductCountsDStream =
                categoryProductPairsDStream.reduceByKeyAndWindow((v1, v2) -> v1 + v2,
        ...
        categoryProductCountsDStream.foreachRDD(categoryProductCountsRDD -> {
            ...
            JavaRDD<Row> categoryProductCountRowRDD = categoryProductCountsRDD.map(
                    categoryProductCount -> RowFactory.create(
                            categoryProductCount._1.split("_")[0],
                            categoryProductCount._1.split("_")[1],
                            categoryProductCount._2));
            ...
            Dataset<Row> categoryProductCountDF = spark.createDataFrame(
