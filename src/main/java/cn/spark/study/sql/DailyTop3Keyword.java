...
public class DailyTop3Keyword {
    ...
    public static void main(String[] args) {
        ...
        final Broadcast<Map<String, List<String>>> queryParamMapBroadcast =
                jsc.broadcast(queryParamMap);

        // 针对HDFS文件中的日志，获取输入RDD
        //Dataset<String> rawRDD = spark.read().textFile("E:\\Git\\spark-study-java\\data\\keyword.txt");
        JavaRDD<String> rawRDD = jsc.textFile("E:\\Git\\spark-study-java\\data\\keyword.txt");
        ...
        Dataset<Row> dailyTop3KeywordDF = spark.sql(""
        ...
        finalDF.write()
                .saveAsTable("daily_top3_keyword_uv");
